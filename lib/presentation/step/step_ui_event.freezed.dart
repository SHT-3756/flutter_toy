...
mixin _$StepUiEvent<T> {
  ...
  @JsonKey(ignore: true)
  $StepUiEventCopyWith<T, StepUiEvent<T>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $StepUiEventCopyWith<T, $Res> {
  factory $StepUiEventCopyWith(
          StepUiEvent<T> value, $Res Function(StepUiEvent<T>) then) =
      _$StepUiEventCopyWithImpl<T, $Res, StepUiEvent<T>>;
  @useResult
  $Res call({String message});
}

/// @nodoc
class _$StepUiEventCopyWithImpl<T, $Res, $Val extends StepUiEvent<T>>
    implements $StepUiEventCopyWith<T, $Res> {
  _$StepUiEventCopyWithImpl(this._value, this._then);
...
class __$$ShowSnackBarCopyWithImpl<T, $Res>
    extends _$StepUiEventCopyWithImpl<T, $Res, _$ShowSnackBar<T>>
...
class _$ShowSnackBar<T> implements ShowSnackBar<T> {
  ...
  @override
  String toString() {
    return 'StepUiEvent<$T>.showSnackBar(message: $message)';
  }
...
abstract class ShowSnackBar<T> implements StepUiEvent<T> {
